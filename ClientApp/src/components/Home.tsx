  ...
  render(): JSX.Element ***REMOVED***
    return (
      <div>
        ...
        <ul>
          <li>
            <a href="https://get.asp.net/">ASP.NET Core</a> and***REMOVED***' '***REMOVED***
        ...
        <ul>
          <li>
            <strong>Client-side navigation</strong>. For example, click***REMOVED***' '***REMOVED***
          ...
          <li>
            ...
            development-time features are disabled, and your***REMOVED***' '***REMOVED***
        ...
        <p>
          ...
          you open a command prompt in that directory, you can run***REMOVED***' '***REMOVED***
          <code>npm</code> commands such as <code>npm test</code> or***REMOVED***' '***REMOVED***
